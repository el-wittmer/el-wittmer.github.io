...
function Hero() {
  return (
    <section id="hero" className="hero">
      <img src="/profile.jpg" alt="Cartoon drawing of Elaina"></img>
      <h1>Elaina Wittmer</h1>
      <p>Human-Centered Computing &gt;&gt; Bridging human behavior and technology to create intuitive digital experiences</p>
