...
title: Currently Learning .v2
---

#### Web Development
I've finished my second web development capstone, which is a resume/personal website created entirely with HTML & Bootstrap. You can find that website [here](https://el-wittmer.github.io/portfolio). In all, I've completed just under 50% of my web development course and have learned a lot about how to create fully functional, responsive web pages.
...
#### Coding Practice
I've postponed work on the Data Science course in favor of practicing problem solving and coding. Since I've been working with web development tools so much, my goal is to keep my Python and Java skills fresh for coding interviews and the like. I've started using LeetCode since it's the most well-known, but I might also work with HackerRank, since I had to use it for an interview recently. 

The problems I've worked on so far have been humbling, but I'm glad for the practice and hope to learn more about algorithm design from other programmers who've been kind enough to offer their own solutions. 