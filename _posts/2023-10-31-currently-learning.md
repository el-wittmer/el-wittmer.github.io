...
#### Web Development
This month, I completed the MongoDB module in my Udemy course and updated my todo list application to have persistent storage ([v2](https://github.com/el-wittmer/todo-it)). After completing this, the course content updated to replace MongoDB with PostgreSQL, so on paper I've made little to no progress on the course this month. I sit at around a 77% completion rate currently.
